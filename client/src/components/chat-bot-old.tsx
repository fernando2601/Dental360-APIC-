...
export function ChatBot() {
  ...
  const keywordResponses: Record<string, string[]> = {
    ...
    "clareamento": [
      "Clareamento de última geração! ⚡ Resultados até 5x mais brancos em poucas sessões. E temos condições especiais hoje!",
      "Nosso clareamento dental é referência na região! 🏆 Tecnologia avançada, sem sensibilidade e com resultados duradouros. Quer agendar?"
    ],
    "siso": [
      "Extrair o siso conosco é super tranquilo! 😌 Técnicas modernas, anestesia de qualidade e uma equipe atenciosa. Vamos agendar?",
      "Problemas com o siso? Nossos cirurgiões são referência! 💪 Procedimento rápido, seguro e com pós-operatório tranquilo. Posso te passar mais informações?"
    ],
    "canal": [
      "Canal hoje em dia é procedimento tranquilo! 😌 Nossos especialistas usam técnicas que tornam tudo mais rápido e confortável. Podemos te ajudar!",
      "Dor por causa de canal? Podemos resolver isso rapidinho! ⚡ Nossa clínica tem os equipamentos mais modernos para tornar o procedimento confortável e eficaz."
    ],
    "aparelho": [
      "Transforme seu sorriso com nossos aparelhos de última geração! 😁 Temos opções discretas e eficientes para todas as necessidades. Quer saber mais?",
      "Alinhamento perfeito em menos tempo! ⏱️ Nossos aparelhos usam tecnologia avançada para resultados mais rápidos. Vamos conversar sobre suas opções?"
    ],
    "dor": [
      "Acabar com sua dor é nossa prioridade número 1! 🛟 Temos horários reservados para emergências. Podemos te atender hoje mesmo!",
      "Dor de dente precisa de atenção imediata! 🚨 Nossos especialistas estão prontos para te ajudar. Que tal um horário prioritário ainda hoje?"
    ],
    "gengiva": [
      "Saúde das gengivas é fundamental! ❤️ Nossa equipe especializada pode ajudar a recuperar sua saúde bucal. Vamos marcar uma avaliação?",
      "Problemas de gengiva têm solução! 👨‍⚕️ Tratamentos modernos e eficazes para devolver a saúde da sua gengiva. Podemos te ajudar!"
    ],
    "porcelana": [
      "Facetas de porcelana de altíssima qualidade! ✨ Tecnologia de ponta para um sorriso perfeito e natural. Quer ver nosso portfolio de antes/depois?",
      "Porcelana de qualidade premium para um sorriso de cinema! 🎬 Resistentes, naturais e com resultado impecável. Vamos agendar uma avaliação?"
    ],
    "lente": [
      "Lentes de contato dental: a revolução da estética! ✨ Resultados impressionantes em pouquíssimo tempo. Quer conhecer essa tecnologia?",
      "Transforme seu sorriso com nossas lentes dentais! 😍 Material de altíssima qualidade e aparência totalmente natural. Vamos conversar sobre isso?"
    ],
    "harmonização": [
      "Harmonização facial de elite! ✨ Nossos profissionais são referência nacional em técnicas avançadas. Quer conhecer nossos resultados?",
      "Harmonização com resultados naturais e elegantes! 🥇 Protocolos exclusivos para realçar sua beleza sem exageros. Vamos marcar uma avaliação personalizada?"
    ],
    "botox": [
      "Botox aplicado por especialistas certificados! 🏆 Resultados naturais que realçam sua beleza. Temos horários disponíveis esta semana!",
      "Botox de qualidade premium com técnica avançada! ✨ Rejuvenescimento natural e expressão preservada. Posso te contar mais sobre nosso diferencial?"
    ],
    "preço": [
      "Investir no seu sorriso é investir em você! 💎 Temos planos que cabem no seu orçamento e parcelamento em até 12x. Posso te passar valores?",
      "Qualidade excepcional com preços justos! 👌 Além disso, parcelamos em condições especiais para você começar seu tratamento hoje mesmo. Quer uma simulação?"
    ],
    "valor": [
      "O valor do seu tratamento depende das suas necessidades específicas! 📊 Mas fique tranquilo, temos opções para todos os orçamentos. Posso fazer um orçamento personalizado?",
      "Investimos em tecnologia para oferecer o melhor custo-benefício! 💰 E temos várias opções de pagamento. Quer saber mais detalhes?"
    ],
    "pagamento": [
      "Facilitamos ao máximo para você! 💳 Aceitamos todos os cartões, PIX, transferência e parcelamos em até 12x. Como prefere pagar?",
      "Seu sorriso novo pode caber no seu bolso! 💸 Temos planos especiais e várias formas de pagamento. Vamos encontrar a melhor opção para você?"
    ]
  };

  // Gera respostas humanizadas com base no script, sentimento e palavras-chave
  const generateHumanizedResponse = (userText: string, sentiment: 'positive' | 'negative' | 'neutral'): Message => {
    ...
    // Casos especiais com frases exatas
    ...
    // Se nenhuma correspondência foi encontrada, retorna uma resposta padrão focada em vendas
    ...
    // Sistema de palavras-chave isoladas
    // Se chegou até aqui, vamos verificar se há palavras-chave isoladas no texto
    // para capturar até mesmo mensagens curtas como "dente" ou "harmonização"
    for (const keyword in keywordResponses) {
      if (lowerText.includes(keyword)) {
        console.log(`Palavra-chave isolada encontrada: ${keyword}`);
        // Escolhe aleatoriamente uma das respostas disponíveis para essa palavra-chave
    ...
    // FALLBACK: Se nenhuma correspondência específica foi encontrada e não estamos em um fluxo,
